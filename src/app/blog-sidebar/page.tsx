...
const BlogSidebarPage = () => {
  // Static blog post data (can be replaced with dynamic fetch)
  const blog = {
    title: "10 amazing sites to download stock photos & digital assets for free",
    author: { name: "Musharof Chy", image: "/images/blog/author-02.png" },
    publishDate: "2024-01-12", // Original date
    tags: [{ name: "Design", slug: "#", color: "#3B82F6" }],
    image: "/images/blog/blog-details-01.jpg",
    content: [
      "Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat.",
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis enim lobortis scelerisque fermentum. Neque sodales ut etiam sit amet. Ligula ullamcorper <strong className='text-primary dark:text-white'> malesuada </strong> proin libero nunc consequat interdum varius. Quam pellentesque nec nam aliquam sem et tortor consequat. Pellentesque adipiscing commodo elit at imperdiet.",
      "Semper auctor neque vitae tempus quam pellentesque nec. <span className='text-primary underline dark:text-white'> Amet dictum sit amet justo </span> donec enim diam. Varius sit amet mattis vulputate enim nulla aliquet porttitor. Odio pellentesque diam volutpat commodo sed.",
    ...
    quote: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod incididunt utionals labore et dolore magna aliqua. Quis lobortis scelerisque fermentum, The Neque ut etiam sit amet.",
  };

  // Format publish date to match current year and time zone (+0545)
  const formattedDate = new Date(blog.publishDate).toLocaleDateString("en-US", {
    year: "numeric",
    month: "short",
    day: "numeric",
    timeZone: "Asia/Kathmandu", // Adjust for +0545
  });
              ...
              <div className="shadow-three dark:bg-gray-dark mt-12 mb-10 rounded-xs bg-white p-6 lg:mt-0 dark:shadow-none">
                <div className="flex items-center justify-between">
                  <input
                    type="text"
                    placeholder="Search here..."
                    className="border-stroke dark:text-body-color-dark dark:shadow-two text-body-color focus:border-primary dark:focus:border-primary mr-4 w-full rounded-xs border bg-[#f8f8f8] px-6 py-3 text-base outline-none transition-all duration-300 dark:border-transparent dark:bg-[#2C303B] dark:focus:shadow-none"
                  />
                  <button
                    aria-label="search button"
                    className="bg-primary flex h-[50px] w-full max-w-[50px] items-center justify-center rounded-xs text-white"
